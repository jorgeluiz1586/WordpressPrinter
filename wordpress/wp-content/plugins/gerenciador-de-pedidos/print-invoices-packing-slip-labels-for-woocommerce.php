 ...
 *
 * @wordpress-plugin
 * Plugin Name:       Gerenciador de Pedidos
 * Plugin URI:        https://www.gerenciadordepedidos.com/product/woocommerce-pdf-invoices-packing-slips/
 * Description:       Gerenciador de Pedidos
 * Version:           1.0
 * Author:            GerenciadorDePedidos
 * Author URI:        https://www.gerenciadordepedidos.com/
 * License:           GPL-2.0+
...
$current_plugin_name='Gerenciador de Pedidos (Basic)';
...
{
    $active_plugin_name='Gerenciador de Pedidos (Pro)';
