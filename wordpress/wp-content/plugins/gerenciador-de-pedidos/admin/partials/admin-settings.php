...
$tab_items=array(
        'documents'=>__('Documentos','print-invoices-packing-slip-labels-for-woocommerce'),
        'general'=>__('Geral','print-invoices-packing-slip-labels-for-woocommerce'),
        'help'=>__('Guia de Suporte','print-invoices-packing-slip-labels-for-woocommerce')
    );
...
if(!empty(Wf_Woocommerce_Packing_List_Admin::not_activated_pro_addons('wt_qr_addon'))){
    $tab_items['freevspro'] = __('Versão Free vs Versão Premium','print-invoices-packing-slip-labels-for-woocommerce');
    $addons_activated_pending = true; 
}else{
    $addons_activated_pending = false;
}
$tab_items['wf-other-solutions'] = __('Outras Soluções', 'print-invoices-packing-slip-labels-for-woocommerce');
$main_module_base = "";
$main_module_id = "";
...
<div class="wt_wrap">
    <div class="wt_heading_section">
        ...
        <?php _e('Configurações','print-invoices-packing-slip-labels-for-woocommerce');?>: 
        <?php _e('Gerenciador de Pedidos', 'print-invoices-packing-slip-labels-for-woocommerce');?>
        </h2>
        <?php
