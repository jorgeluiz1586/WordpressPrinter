...
{
	protected $api_url='https://feedback.gerenciadordepedidos.com/wp-json/wfinvoice/v1/uninstall';
            ...
            <div class="wfinvoice-modal-wrap">
                ...
                <div class="wfinvoice-modal-body">
                    ...
                    <div class="wt_pklist_policy_infobox">
                        ...
                        <a href="https://www.gerenciadordepedidos.com/privacy-policy/" target="_blank"><?php _e('Privacy Policy', 'print-invoices-packing-slip-labels-for-woocommerce');?></a>        
                    </div>
                </div>
                <div class="wfinvoice-modal-footer">
                    <a class="button-primary" href="https://www.gerenciadordepedidos.com/support/" target="_blank">
