...
.wt_heading_1{text-align:center;font-style: normal;font-weight: bold;}
...
.wt_free_btn_a{}
.wt_get_premium_btn {text-align:center;padding: 6px 1px 6px 1px;height:auto;max-height: 100px; width:100%; background: linear-gradient(90.67deg, #2608DF -34.86%, #3284FF 115.74%);box-shadow: 0px 4px 13px rgb(46 80 242 / 39%);border-radius: 5px;display: inline-block;font-style: normal;font-size: 12px;line-height: 18px;color: #FFFFFF;text-decoration: none;}
...
.wt_free_btn{height:auto;max-height: 100px;min-height: 30px;width:109px; border-style: solid;border-color: #2A2EEA;border-radius: 5px;color: #2A2EEA;cursor: pointer;}
</style>
<div class="wf-tab-content" data-id="<?php echo esc_attr($target_id);?>">
    <div class="wt_row"> 
        <div clas="wt_headings">
            <h1 class="wt_heading_1"><?php _e('More Plugins To Make Your Store Stand Out', 'print-invoices-packing-slip-labels-for-woocommerce'); ?></h1>
            <h2 class="wt_heading_2"><?php _e('Check out our other plugins that are perfectly suited for WooCommerce store needs.', 'print-invoices-packing-slip-labels-for-woocommerce'); ?></h2> 
        </div>
    <div class="wt_column">
<?php 
...
$plugins=array(
    'wt_ipc_addon' => array(
        ...
        'premium_url'   => 'https://www.gerenciadordepedidos.com/product/woocommerce-pdf-invoices-packing-slips/?utm_source=other_solution_page&utm_medium=free_plugin&utm_campaign=PDF_invoice',
        'basic_url'     => '',
    ...
    'wt_sdd_addon' => array(
        ...
        'premium_url'   => 'https://www.gerenciadordepedidos.com/product/woocommerce-shipping-labels-delivery-notes/?utm_source=other_solution_page&utm_medium=free_plugin&utm_campaign=Shipping_Label',
        'basic_url'     => '',
    ...
    'wt_pl_addon' => array(
        ...
        'premium_url'   => 'https://www.gerenciadordepedidos.com/product/woocommerce-picklist/?utm_source=other_solution_page&utm_medium=free_plugin&utm_campaign=Picklist',
        'basic_url'     => '',
    ...
    'wt_pi_addon' => array(
        ...
        'premium_url'   => 'https://www.gerenciadordepedidos.com/product/woocommerce-proforma-invoice/?utm_source=other_solution_page&utm_medium=free_plugin&utm_campaign=Proforma_Invoice',
        'basic_url'     => '',
    ...
    'wt_al_addon' => array(
        ...
        'premium_url'   => 'https://www.gerenciadordepedidos.com/product/woocommerce-address-label/?utm_source=other_solution_page&utm_medium=free_plugin&utm_campaign=Address_Label',
        'basic_url'     => '',
        'pro_plugin'    => 'wt-woocommerce-addresslabel-addon/wt-woocommerce-addresslabel-addon.php',
        'basic_plugin'  => '',
    ),
    'product_feed_sync' => array(
        'title'         => __('GerenciadorDePedidos WooCommerce Product Feed & Sync Manager', 'print-invoices-packing-slip-labels-for-woocommerce'),
        ...
        'premium_url'   => 'https://www.gerenciadordepedidos.com/product/product-catalog-sync-for-facebook/?utm_source=other_solution_page&utm_medium=free_plugin&utm_campaign=WooCommerce_Product_Feed',
        'basic_url'     => 'https://wordpress.org/plugins/gerenciadordepedidos-product-feed/',
        'pro_plugin'    => 'gerenciadordepedidos-product-feed-pro/gerenciadordepedidos-product-feed-pro.php',
        'basic_plugin'  => 'gerenciadordepedidos-product-feed/gerenciadordepedidos-product-feed.php',
    ),
    'request_quote' => array(
        'title'         => __('GerenciadorDePedidos Woocommerce Request a Quote', 'print-invoices-packing-slip-labels-for-woocommerce'),
        ...
        'premium_url'   => 'https://www.gerenciadordepedidos.com/product/woocommerce-request-a-quote/?utm_source=other_solution_page&utm_medium=free_plugin&utm_campaign=Request_Quote',
        'basic_url'     => '',
    ...
    'diplay_discount' => array(
        ...
        'premium_url'   => 'https://www.gerenciadordepedidos.com/product/display-woocommerce-discounts/?utm_source=other_solution_page&utm_medium=free_plugin&utm_campaign=Display_Discounts',
        'basic_url'     => '',
        'pro_plugin'    => 'wt-display-discounts-for-woocommerce/wt_display_discounts_for_woocommerce.php',
        'basic_plugin'  => '',
    ),
    'best_sellers_plugin' => array(
        'title'         => __('GerenciadorDePedidos WooCommerce Best Sellers', 'print-invoices-packing-slip-labels-for-woocommerce'),
        ...
        'premium_url'   => 'https://www.gerenciadordepedidos.com/product/woocommerce-best-sellers/?utm_source=other_solution_page&utm_medium=free_plugin&utm_campaign=WooCommerce_Best_Sellers',
        'basic_url'     => '',
        'pro_plugin'    => 'wt-woocommerce-best-seller/wt-woocommerce-best-sellers.php',
        'basic_plugin'  => '', 
    ),
    'giftcards_plugin' => array(
        'title'         => __('GerenciadorDePedidos WooCommerce Gift Cards', 'print-invoices-packing-slip-labels-for-woocommerce'),
        ...
        'premium_url'   => 'https://www.gerenciadordepedidos.com/product/woocommerce-gift-cards/?utm_source=other_solution_page&utm_medium=free_plugin&utm_campaign=WooCommerce_Gift_Cards',
        'basic_url'     => '',
    ...
    'fbt_plugins' => array(
        ...
        'premium_url'   => 'https://www.gerenciadordepedidos.com/product/woocommerce-frequently-bought-together/?utm_source=other_solution_page&utm_medium=free_plugin&utm_campaign=Frequently_Bought_Together',
        'basic_url'     => '',
    ...
    'gdpr_cookie_consent_plugin' => array(
        ...
        'premium_url'   => 'https://www.gerenciadordepedidos.com/product/gdpr-cookie-consent/?utm_source=other_solution_page&utm_medium=_free_plugin_&utm_campaign=GDPR',
        'basic_url'     => 'https://wordpress.org/plugins/cookie-law-info/',
        'pro_plugin'    => 'gerenciadordepedidos-gdpr-cookie-consent/cookie-law-info.php',
    ...
    'product_import_export_plugin' => array(
        ...
        'premium_url'   => 'https://www.gerenciadordepedidos.com/product/product-import-export-woocommerce/?utm_source=other_solution_page&utm_medium=free_plugin&utm_campaign=Product_Import_Export',
    ...
    'customers_import_export_plugin' => array(
        ...
        'premium_url'   => 'https://www.gerenciadordepedidos.com/product/wordpress-users-woocommerce-customers-import-export/?utm_source=other_solution_page&utm_medium=free_plugin&utm_campaign=User_Import_Export',
    ...
    'order_import_export_plugin' => array(
        ...
        'premium_url'   => 'https://www.gerenciadordepedidos.com/product/order-import-export-plugin-for-woocommerce/?utm_source=other_solution_page&utm_medium=free_plugin&utm_campaign=Order_Import_Export',
    ...
    'import_export_suit' => array(
        ...
        'premium_url'   => 'https://www.gerenciadordepedidos.com/product/woocommerce-import-export-suite/?utm_source=other_solution_page&utm_medium=free_plugin&utm_campaign=Import_Export_Suite',
        'basic_url'     => '',
        'pro_plugin'    => array(
    ...
    'smart_coupons_plugin' => array(
        ...
        'premium_url'   => 'https://www.gerenciadordepedidos.com/product/smart-coupons-for-woocommerce/?utm_source=other_solution_page&utm_medium=free_plugin&utm_campaign=smart_coupons',
    ...
    'url_coupons_plugin' => array(
        ...
        'premium_url'   => 'https://www.gerenciadordepedidos.com/product/url-coupons-for-woocommerce/?utm_source=other_solution_page&utm_medium=free_plugin&utm_campaign=URL_Coupons',
        'basic_url'     => '',
        'pro_plugin'    => 'wt-woocommerce-gift-cards/wt-woocommerce-gift-cards.php',
        'basic_plugin'  => '', 
    ),
    'paypal_express_checkout_plugin' => array(
        ...
        'premium_url' => 'https://www.gerenciadordepedidos.com/product/paypal-express-checkout-gateway-for-woocommerce/?utm_source=other_solution_page&utm_medium=free_plugin&utm_campaign=Paypal',
    ...
    'stripe_paymet_gateway_plugin' => array(
        ...
        'premium_url' => 'https://www.gerenciadordepedidos.com/product/woocommerce-stripe-payment-gateway/?utm_source=other_solution_page&utm_medium=free_plugin&utm_campaign=Stripe',
    ...
    'subscriptions_for_woocommerce_plugin' => array(
        ...
        'premium_url' => 'https://www.gerenciadordepedidos.com/product/woocommerce-subscriptions/?utm_source=other_solution_page&utm_medium=free_plugin&utm_campaign=Subscriptions',
        'basic_url' => '',
    ...
    'sequential_order_plugin' => array(
        ...
        'premium_url' => 'https://www.gerenciadordepedidos.com/product/woocommerce-sequential-order-numbers/?utm_source=other_solution_page&utm_medium=free_plugin&utm_campaign=Sequential_Order_Numbers',
    ...
    'backup_and_migration_plugin' => array(
        ...
        'premium_url' => 'https://www.gerenciadordepedidos.com/product/wordpress-backup-and-migration/?utm_source=other_solution_page&utm_medium=free_plugin&utm_campaign=WordPress_Backup',
            ...
            <div class="wt_widget">
                <div class="wt_widget_title_wrapper">
                    <div class="wt_widget_column_1">
                        <img src="<?php echo esc_url($wf_admin_img_path_os . '/' . $value['image_url']);?>">
                    </div>
                ...
                <div class="wt_buttons">
                    <div class="wt_premium_button" style="width: 100%;">
                        <a href="<?php echo esc_url($value['premium_url']); ?>" class="wt_get_premium_btn" target="_blank"><img src="<?php echo esc_url($wf_admin_img_path_os . '/promote_crown.png');?>" style="width: 10px;height: 10px;"><?php  _e(' Get Premium','print-invoices-packing-slip-labels-for-woocommerce'); ?></a>
                    </div> 
<?php
...
?>
                    <div class="wt_installed_button">
                        <button class="wt_installed_btn">
                            <?php _e('Installed','print-invoices-packing-slip-labels-for-woocommerce'); ?>
                        </button>
                    </div>
<?php               
                    ...
                    <div class="wt_free_button">
                        <a class="wt_free_btn_a" href="<?php echo esc_url($value['basic_url']); ?>" target="_blank">
                            <button class="wt_free_btn">
                                <?php _e('Get Free Plugin','print-invoices-packing-slip-labels-for-woocommerce'); ?>
                            </button>
                        </a>
                    </div>
