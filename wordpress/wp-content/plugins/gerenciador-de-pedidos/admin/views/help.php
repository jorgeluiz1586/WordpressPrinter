		...
		<div class="wf_sub_tab_content" data-id="help-links" style="display:block;">
			...
			<ul class="wf-help-links">
			    <li>
			        ...
			        <a target="_blank" href="https://www.gerenciadordepedidos.com/woocommerce-pdf-invoices-packing-slips-delivery-notes-shipping-labels-userguide-free-version/" class="button button-primary">
			    ...
			    <li>
			        ...
			        <a target="_blank" href="https://www.gerenciadordepedidos.com/support/" class="button button-primary">
