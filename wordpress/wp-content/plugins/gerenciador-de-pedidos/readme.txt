...
Contributors: GerenciadorDePedidos
Version: 1.0
Donate link: https://www.gerenciadordepedidos.com/plugins/
...
Read detailed instructions on how to set up the plugin in the [PDF invoice setup guide](https://www.gerenciadordepedidos.com/woocommerce-pdf-invoices-packing-slips-delivery-notes-shipping-labels-userguide-free-version/).
...
[mPDF add-on for PDF Invoices, Packing Slips, Delivery Notes and Shipping Labels by GerenciadorDePedidos](https://wordpress.org/plugins/mpdf-addon-for-pdf-invoices/ "RTL and Unicode language add-on for PDF invoice plugin by GerenciadorDePedidos").
...
[QR Code Add-on for WooCommerce PDF Invoices by GerenciadorDePedidos](https://www.gerenciadordepedidos.com/product/qr-code-addon-for-woocommerce-pdf-invoices/ "QR Code Add-on for PDF invoice plugin by GerenciadorDePedidos").
...
* [WooCommerce PDF Invoices, Packing Slips & Credit Notes Plugin](https://www.gerenciadordepedidos.com/product/woocommerce-pdf-invoices-packing-slips/)
* [WooCommerce Shipping Labels, Dispatch Labels & Delivery Notes Plugin](https://www.gerenciadordepedidos.com/product/woocommerce-shipping-labels-delivery-notes/)
* [WooCommerce Address Labels Plugin](https://www.gerenciadordepedidos.com/product/woocommerce-address-label/)
* [WooCommerce Picklists Plugin](https://www.gerenciadordepedidos.com/product/woocommerce-picklist/)
* [WooCommerce Proforma Invoices Plugin](https://www.gerenciadordepedidos.com/product/woocommerce-proforma-invoice/)
...
For the complete list of features and details check out the [WooCommerce PDF Invoices, Packing Slips & Credit Notes plugin](https://www.gerenciadordepedidos.com/product/woocommerce-pdf-invoices-packing-slips/).
...
Check out the full details of the [WooCommerce Shipping Labels, Dispatch Labels & Delivery Notes plugin](https://www.gerenciadordepedidos.com/product/woocommerce-shipping-labels-delivery-notes/).
...
Refer to the [WooCommerce Address Labels plugin](https://www.gerenciadordepedidos.com/product/woocommerce-address-label/) page for full details. 
...
Take a look at the [WooCommerce Picklists plugin](https://www.gerenciadordepedidos.com/product/woocommerce-picklist/) page to know more. 
...
Know more about the plugin and its features from [WooCommerce Proforma Invoices plugin](https://www.gerenciadordepedidos.com/product/woocommerce-proforma-invoice/) page. 
...
= About GerenciadorDePedidos =

GerenciadorDePedidos creates quality WordPress/WooCommerce plugins that are easy to use and customize. We are proud to have thousands of customers actively using our plugins across the globe.
...
Yes. To add a logo to the invoice, first, you need to upload your company logo within the general settings section of the plugin. Then go to the invoice customization, expand the company logo section, and choose the company logo from the drop-down. You can refer to this [user guide](https://www.gerenciadordepedidos.com/woocommerce-pdf-invoices-packing-slips-delivery-notes-shipping-labels-userguide-free-version/#customize) for more information. 
...
= 3.0.0 =
* [Enhancement] - Added option to add the QR code on the invoice using QR Code Add-on for WooCommerce PDF Invoices by gerenciadordepedidos
